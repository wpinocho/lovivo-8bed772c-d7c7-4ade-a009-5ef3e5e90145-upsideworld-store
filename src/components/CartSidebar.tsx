          ...
          {state.items.length === 0 ? (
            <div className="flex-1 flex items-center justify-center p-6">
              <div className="text-center">
                ...
                <Button onClick={onClose} variant="outline" className="border-primary text-primary hover:bg-primary hover:text-primary-foreground">
                  Seguir Comprando
                </Button>
              </div>
            </div>
            ...
            <>
              ...
              <div className="border-t border-border p-6 bg-card">
                ...
                <Button 
                  className="w-full mt-4 bg-primary hover:bg-primary/90 text-primary-foreground neon-glow-red" 
                  size="lg" 
                  onClick={handleCreateCheckout} 
                  disabled={isCreatingOrder}
                >
                  {isCreatingOrder ? '⏳ Procesando...' : '🚀 Comprar Ahora'}
                </Button>
              </div>
            </>
          )}
